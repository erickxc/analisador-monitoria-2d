...
DESCRICAO_ANALISE = {
    ...
    "alto_giro": "Status do mês mais recente de cada produto de alto giro, considerando só clientes do Grupo 1: receita, se está em alta ou queda vs. o mês anterior, o cliente que mais comprou e o que mais reduziu a compra (nunca o mesmo cliente nos dois — quem caiu não conta como destaque, mesmo sendo o maior comprador do mês), cada um com a variação % da própria compra. Some/entra sozinho conforme os produtos considerados mudam.",
